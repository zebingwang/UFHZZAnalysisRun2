...
#                              jetSrc       = cms.untracked.InputTag("slimmedJets"),
                             ...
                             genIsoCutEl = cms.untracked.double(0.35),
                             genIsoCutMu = cms.untracked.double(0.35),
                             genIsoConeSizeEl = cms.untracked.double(0.3),
                             genIsoConeSizeMu = cms.untracked.double(0.3),
